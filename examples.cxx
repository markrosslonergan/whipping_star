...
if(test_mode==1){
	...
	SBNspec bkg_spec("precomp/SBN_bkg_all", xml);
	bkg_spec.compressVector();
	SBNchi test_chi(bkg_spec);
	SBNspec sig_spec("precomp/SBN_bkg_all", xml);
 ...
 ************************************************************/
	...
	SBNosc oscSig("precomp/SBN_bkg_all",xml);
	oscSig.setAppMode();
 ...
 ************************************************************/
	...
	SBNosc inject_sig("precomp/SBN_bkg_all",xml);
	...
	SBNosc test_sig("precomp/SBN_bkg_all",xml);
