all:	
	...
	g++ -g -std=c++11  -Wall -fPIC  -Wno-deprecated-declaratios tinyxml/* SBNfit3pN.o test.o prob.o SBNfit.o SBNconfig.o SBNspec.o SBNosc.o SBNchi.o -o test -lgsl -lgslcblas -L/home/mark/programs/root/root/lib -lCore -lRIO -lNet -lHist -lGraf -lGraf3d -lGpad -lTree -lRint -lPostscript -lMatrix -lPhysics -lMathCore -lMathMore -lThread -lMultiProc -pthread -lm -ldl -rdynamic -I $$ROOTSYS/include 
