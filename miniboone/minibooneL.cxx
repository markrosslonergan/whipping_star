...
//	     0.04758899      0.65133480    317.60513306 C
//	     0.01000000      0.00030000    333.10394287 C
//      2.46485972      0.00038829    175.90411377 N OK
//      4.21304832      0.04001587    337.26443481 N OK 
//     0.66124688      0.46204867    451.23800659 B OK
//     0.69426881      0.00468008    145.39331055 B OK


	oscillateFast( 0.69426881, 0.00468008, &test.hist.at(0), tupB);//   
	//oscillateFast( 0.01,    0.0003, &test.hist.at(3), tupB);//    317.60513306
...
//	std::cout<<std::setprecision(10)<<tt.CalcChiLog(&obs_spec)<<" "<<175.90411377<<" "<<tt.CalcChiLog(&obs_spec)/175.90411377<<std::endl;
	...
	std::cout<<std::setprecision(15)<<"Minimum chi is "<<min<<" at m: "<<minM<<" and "<<minS<<std::endl;
	...
	TFile * fout = new TFile("Log_ans_comb.root","RECREATE");
